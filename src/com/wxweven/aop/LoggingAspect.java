...
public class LoggingAspect {
	 ...
	 * @Before() 只接受 常量
	 */
	public static final String pointcut = "execution(* com.atguigu.spring.aop.ArithmeticCalculator.*(..))";
	 ...
	 * 
	 * try { //前置通知 System.out.println("The method " + methodName +
	 * " begins with " + Arrays.asList(pjd.getArgs())); //执行目标方法 result =
	 * pjd.proceed(); //返回通知 System.out.println("The method " + methodName +
